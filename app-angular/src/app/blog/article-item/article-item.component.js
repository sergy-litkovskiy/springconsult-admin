...
var AppArticleItemComponent = (function () {
    ...
    AppArticleItemComponent.prototype.ngOnInit = function () {
        ...
        this.articleService.selectedArticleItem
            ...
            _this.selectedArticleItem = articleItem;
        });
        this.route.params
    ...
    AppArticleItemComponent.prototype.initForm = function () {
        ...
        this.articleForm = new forms_1.FormGroup({
            ...
            'date': new forms_1.FormControl(this.articleItem.date, forms_1.Validators.required),
            'time': new forms_1.FormControl(this.articleItem.time, forms_1.Validators.required),
            ...
            'image': new forms_1.FormControl(this.articleItem.image),
